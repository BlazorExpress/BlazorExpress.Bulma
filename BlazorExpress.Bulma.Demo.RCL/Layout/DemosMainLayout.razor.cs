...
public partial class DemosMainLayout : MainLayoutBase
{
    ...
    private HashSet<LinkGroup> GetLinkGroups()
    {
        ...
        groups.Add(new LinkGroup
        {
            ...
            CssClass = "is-size-7 has-text-weight-bold has-text-primary",
            Links = [
                new Link { Href = DemoRouteConstants.Demos_Form_CheckboxListInput_Documentation , Text = "Checkbox List Input" },
                new Link { Href = DemoRouteConstants.Demos_Form_CheckboxInput_Documentation , Text = "Checkbox Input" },
                ...
                new Link { Href = DemoRouteConstants.Demos_Form_RadioListInput_Documentation , Text = "Radio List Input" },
                new Link { Href = DemoRouteConstants.Demos_Form_RadioInput_Documentation , Text = "Radio Input" },
                new Link { Href = DemoRouteConstants.Demos_Form_SelectInput_Documentation , Text = "Select Input" },
        ...
        groups.Add(new LinkGroup
        {
            ...
            Links = [
                ...
                new Link { Href = DemoRouteConstants.Demos_Menu_Documentation, Text = "Menu" },
