...
/// <summary>
/// Represents an item used by <see cref="CheckboxListInput{TValue}" />.
/// </summary>
/// <typeparam name="TValue">The type of the checkbox value.</typeparam>
public class CheckboxListInputItem<TValue>
{
    #region Constructors

    public CheckboxListInputItem()
    {
    }

    public CheckboxListInputItem(TValue value, string text)
    {
        Value = value;
        Text = text;
    }
